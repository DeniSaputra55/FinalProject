...
<h1 align="center">Detail penginapan</h1>
  ...
  <div class="row">
    <div class="col-md-5">
      <div class="project-info-box mt-0">
        <h5>Detail penginapan</h5>
        <p><i class="fas fa-id-badge"></i> <b>ID:</b> {{$w->id}}</p>
<p><i class="fas fa-heading"></i> <b>Nama:</b> {{$w->nama}}</p>
<p><i class="fas fa-info-circle"></i> <b>Deskripsi:</b> {{$w->fasilitas}}</p>
<p><i class="fas fa-map-marker-alt"></i> <b>Kota:</b> {{$w->alamat}}</p>
<p><i class="fas fa-money-bill"></i> <b>Harga:</b> {{$w->harga}}</p>
<p><i class="fas fa-star"></i> <b>Kelas:</b> {{$w->kelas}}</p>
