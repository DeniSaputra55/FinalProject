                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{url('admin/penginapan')}}">Data Penginapan</a>
                                    <!-- <a class="nav-link" href="{{url('admin/review')}}">Data Ulasan</a> -->
                                    <a class="nav-link" href="{{url('admin/reviewwisata')}}">Data Review Wisata</a>
